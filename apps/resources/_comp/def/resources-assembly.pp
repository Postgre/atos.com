...
<public-part
	...
	<name>resources-assembly</name>
	<purpose>assembly</purpose>
	<caption>Assembly PP for Resources</caption>
	<entities>
		<entity>
			<name>com.atos.bundles</name>
			<package>com/atos/bundles</package>
			<caption>com.atos.bundles</caption>
			<description>com.atos.bundles</description>
