                ...
                <sap:panelGroup width="80%" valign="middle">
                    <sap:panelGrid width="100%" cellHalign="center" cellValign="middle">
                        ...
                        <sap:panelGroup id="labelCell10" valign="middle" halign="right"  width="25%" >
                        	<sap:outputLabel id="CustomLabel1"  value= "Operation Confirmation: "></sap:outputLabel>
                        </sap:panelGroup>                      
                            <sap:panelGroup id="customAdded1" halign="left" valign="middle" width="25%">
								<sap:panelGrid >									
                                	<sap:inputText   id="OperationConfrm" value="#{podHeaderExtension.operationConfirmation}"  ></sap:inputText>
                                	 <sap:outputLabel id="blank1234"  value= " "></sap:outputLabel>
                                   	<sap:commandButton id="Search" title="Search" action="#{podHeaderExtension.postScanOperation}"></sap:commandButton>
                           		</sap:panelGrid>
                            </sap:panelGroup>
