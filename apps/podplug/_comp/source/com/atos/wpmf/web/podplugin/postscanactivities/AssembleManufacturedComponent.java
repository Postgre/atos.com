...
public  void assembleManufacturedComponent(String operationRef,String resourceRef,SfcBasicData sfcBasicDataSubAssy)throws PODCustomException{
	...
	try {
		...
		new AssembleData().assembleComponent(basicDataForParent,resourceRef,operationRef,null,null,itemKeyData.getItem(),basicDataForParent.getSfc());
		//consume the sfc 
		...
		MessageHandler.handle("Assembled successfully" , null, MessageType.INFO);
