...
import com.atos.wpmf.web.podplugin.postscanactivities.CompleteActiveSfc;
import com.atos.wpmf.web.podplugin.postscanactivities.PODCustomException;
import com.atos.wpmf.web.podplugin.postscanactivities.PVTCheck;
import com.atos.wpmf.web.podplugin.postscanactivities.StartInQueueSfc;
			...
			if(sfcBasicData ==null || basicConfiguration.getStatus().equals("405")){
				...
				if(basicConfiguration.getStatus().equals("407") ){
					...
					//Check given sfc is in queue					
						boolean startSfc=new StartInQueueSfc().startSfc(sfcBasicData, this.operationRef,this.resourceRef);
						if(!startSfc){
