	...
	public void postScanOperations(String operationRef,String resourceRef,String barcode)throws PODCustomException{
		...
		if(barcode.matches(PVT_PATTERN)){	
			...
			try {
				...
				throw new PODCustomException("InvalidSFCException exception while assembling manufactured component");
			}catch(BusinessException businessException){
				throw new PODCustomException("Business Exception while assembling manufactured component ");
			}
