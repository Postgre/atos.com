...
<f:subview id="headerView">
    ...
    <sap:pageHeader id="headerContainer" >
        ...
        <f:facet name="header">
            <h:outputText id="pageHeaderTitle" value="Custom POD for VE" />
        </f:facet>
        ...
        <sap:panelGrid cellBackgroundDesign="transparent" width="100%" height="0px" cellHalign="start" cellValign="top" columns="1">
            ...
            <sap:panelGroup backgroundDesign="transparent" width="100%" height="0px">
                ...
                <sap:poll id="refreshTrigger" rendered="#{refreshPlugin.enableTrigger}"
                                    interval="#{refreshPlugin.pollingPeriod}"
                                    actionListener="#{refreshPlugin.processRefresh}" >
                </sap:poll>
            </sap:panelGroup>
