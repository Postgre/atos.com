	  ...
	  <sap:panel id="reportsPanel2" width="100%" height="100%" isCollapsible="false"
        ...
        <sap:panelGrid width="100%" height="100%" cellHalign="start" cellValign="top">
        	<sap:panelRow>
      		...
      		<sap:panelGroup  valign="middle" halign="left"  width="100%" height="5%" >
			...
			<sap:panelRow cellpadding="10 10 10 10">
                        <sap:panelGroup id="labelCell100" valign="middle" halign="left" height="20%"width="100%" >
	                         <table style="width:100%">
	                         <tr>
		                         <td width="5%"><sap:outputLabel id="CustomLabel12"  value= "Scanned Component: "></sap:outputLabel>   </td>
		                         <td width="2%"><sap:outputLabel id="blank123456"  value= " "></sap:outputLabel></td>
		                         <td><sap:inputText   id="OperationConfrm1" value="#{assemblyPlugin.operationConfirmation}"></sap:inputText></td>
		                         <td width="3%"><sap:commandButton id="Search1" title="Search" action="#{assemblyPlugin.postScanOperation}"></sap:commandButton></td>
