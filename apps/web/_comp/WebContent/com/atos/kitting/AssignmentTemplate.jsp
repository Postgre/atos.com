...
<f:view>
	...
	<sap:body title="KIT ASSIGNMENT MAINTENANCE" id="body" height="60%" browserHistory="disabled" focusId="kittingAssignmentForm">
					...
					cellValign="top" columns="1">
						...
						<td>
							...
							<sap:commandButtonLarge id="saveMaterial" value="Save"
										width="90px" height="15px" actionListener="#{kitAssignmentScreenControllerBean.saveMaterialData}">
							</sap:commandButtonLarge>
									...
									<sap:dataTable
									   ...
									   <sap:rowSelector
										...
										<sap:column>
											...
											<sap:selectOneMenu id="kitnumber" value="#{rows.kitnoAlt}">
						...
						<sap:panelPopup id="confirmationPopup"
								...
								<sap:panelGrid width="100%" height="100%"
									...
									<h:panelGroup>
										<h:outputLabel
											value=" SFC #{orderCreationDataBeanVolvo.material} is already ASSIGNED to another Kit. Do you want to Update it ? "></h:outputLabel>
										
									</h:panelGroup>
									<h:panelGroup>
										<sap:commandButton id="confirmationButtonYes" value="Yes"
											width="70px"
											actionListener="#{kitAssignmentScreenControllerBean.confirmYes}"></sap:commandButton>
										<fh:outputLabel value=" " ></fh:outputLabel>
										<sap:commandButton id="confirmationButtonNo" value="No"
											width="70px"
											actionListener="#{kitAssignmentScreenControllerBean.confirmNo}"></sap:commandButton>
									</h:panelGroup>
								</sap:panelGrid>
						</sap:panelPopup>
				</h:form>
