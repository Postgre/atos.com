			  ...
			  String materialRef = null;
				...
				if(operationRef == null){
				  ...
				  if(workInstr==null){ 
					  ...
					  UIComponent comp=getOperationConfrmComponent();
					  if(comp != null){
						  if(((UIInputText)comp).getValue()!=null){
							  String sfc = (String)((UIInputText)comp).getValue();
...
//			  reportUrl= "file://Winsrv2k8r2/wi/20_16_CABIN_CHECK_SHEET.pdf";
	...
	private UIComponent getOperationConfrmComponent() {
		UIComponent comp = null;
		UIComponent panel = getContainer();
		panel = findComponent(FacesUtility.getFacesContext().getViewRoot(),
				"podSelection");
	...
	public void processPluginLoaded() {
		...
		//	excludedIdList.add("INPUT_ID_Label");
			...
			if(this.reportUrl !=null && !this.reportUrl.equals("")){
				MessageHandler.clear();
	    		MessageHandler.handle("Sfc "+this.sfcStarted+" started successfully" , null, MessageType.INFO);
			}
