...
public class CompleteActiveSfc  extends com.sap.me.production.podclient.BasePodPlugin {
	...
	public void completeSfc(SfcBasicData sfcBasisData,String operationRef,String resourceRef) throws PODCustomException{
				...
				try {
					...
					for(SfcBasicData basicData:basicDatas){
						if(!basicData.getSfc().equals(sfcBasisData.getSfc())){
							...
							sfcCompleted= sfcCompleted+basicData.getSfc()+" ";
						}
					}
