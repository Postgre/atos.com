...
import com.sap.me.datatype.RequiredValueValidationException;
...
//						assemblyDataServiceInterface.validateAssemblyFields()
				...
				throw new PODCustomException("Scanned Component is  Already Assembled .");
			}catch (MissingOperationException e) {
				e.printStackTrace();
				throw new PODCustomException("Operation missing during assembly ");
				
			} catch (NotEnoughUnfilledQuantityException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
				throw new PODCustomException("Not Enough Unfilled Quantity during assembly ");
			} catch (NoComponentsToAssembleException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
				throw new PODCustomException("No Components To Assemble Exception during assembly");
			} catch (InvalidAssemblyDataException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
				throw new PODCustomException("Invalid Assembly Data");
