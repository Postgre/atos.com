package com.atos.orderboardvolvo.sequncing;
...
public class OrderReleaseDataController extends BasePodPlugin implements
	...
	public void clear(ActionEvent event) 
	{
		...
		// clear bean caches
		FacesUtility.removeSessionMapValue("orderSequencingDataBean");
	...
	public void initializeData() {
		...
		if (FacesUtility.getSessionMapValue("MATERIAL_FOR_SEQ") != null) {
			this.disableMaterial = true;
			this.material = (String) FacesUtility
					.getSessionMapValue("MATERIAL_FOR_SEQ");
		...
		if (FacesUtility.getSessionMapValue(SEQUENCING_RULE) != null) {

			if (((String) FacesUtility.getSessionMapValue(SEQUENCING_RULE))
					.equals(YES)) {
	...
	public void setActivityRuleValues() throws BusinessException {
		...
		if (activity != null) {
			...
			for (ActivityOption activityOption : activityOptions) {
				...
				if (optionName.equals("MATERIAL_FOR_SEQ")) {
					// this.material = optionValue;
					// this.disableMaterial = true;
					HttpSession httpSession = FacesUtility.getHttpSession();
					httpSession.setAttribute("MATERIAL_FOR_SEQ", optionValue);
					material = optionValue;

				}
				if (optionName.equals(SEQUENCING_RULE)) {
					// this.material = optionValue;
					// this.disableMaterial = true;
					HttpSession httpSession = FacesUtility.getHttpSession();
					httpSession.setAttribute(SEQUENCING_RULE, optionValue);
			...
			if (material == null) {
				FacesUtility.getHttpSession().removeAttribute("MATERIAL_FOR_SEQ");
			}
			...
			if (sequence == null) {
				FacesUtility.getHttpSession().removeAttribute(SEQUENCING_RULE);
			}
